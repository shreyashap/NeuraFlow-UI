...
export const TextRevealCard = ({ text, revealText, children, className }) => {
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-slate-900 opacity-70 border border-white/[0.08] w-[40rem] rounded-lg p-8 relative overflow-hidden",
        className
      )}
    >
      {children}
      <div className="h-16 relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-slate-800 z-20  will-change-transform"
        >
          <p
            style={{
        ...
        <div className="w-full overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)] ">
          <p className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238] text-white text-center">
            {text}
          </p>
          <MemoizedStars />
        </div>
